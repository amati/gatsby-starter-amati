...
1.  **Create a Gatsby site.**
    ...
    ```shell
    # create a new Gatsby site using gatsby-starter-amati
    gatsby new YOUR-BLOG-REPOSITORY https://github.com/amati/gatsby-starter-amati
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `YOUR-BLOG-REPOSITORY` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
